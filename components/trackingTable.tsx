                                            ...
                                            <div key={day.date.toDateString() + "stat"} className={`flex flex-row bg-white border-b border-t border-black/1 align-middle h-[50px] items-center  justify-between text-center font-bold"}`}>
                                                ...
                                                {EnabledMetrics.dieta ?
                                                    <div
                                                        ...
                                                        <a>{getLast30DaysStatsByIndex(index, Days, EnabledMetrics).diet?.total + " 🥦"}  </a>
                                                        <a>{getLast30DaysStatsByIndex(index, Days, EnabledMetrics).diet?.percentage! + "%"}</a>
                                                    </div>
                                                    :
                                                    <div className="w-[50px]" />
                                                }
                                                ...
                                                {EnabledMetrics.treino ?
                                                    <div
                                                        ...
                                                        <a>{getLast30DaysStatsByIndex(index, Days, EnabledMetrics).exercise?.total + " 💪"}  </a>
                                                        <a>{getLast30DaysStatsByIndex(index, Days, EnabledMetrics).exercise?.percentage! + "%"}</a>
                                                    </div>
                                                    :
                                                    <div className="w-[50px]" />
                                                }
                                                ...
                                                {EnabledMetrics.peso ?
                                                    <div
                                                        ...
                                                        <a className="align-middle">{getLast30DaysStatsByIndex(index, Days, EnabledMetrics).weight?.total + " kg"}</a>
                                                    </div>
                                                    :
                                                    <div className="w-[55px] h-[40px]" />
                                                }
