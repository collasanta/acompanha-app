            ...
            <div className="flex justify-center px-[5px]">
                <div className="max-w-[550px] w-full mb-[100px] shadow-lg border-r-2 border-l-2 border-b-2 mt-3  ">
                    <div className="flex flex-col w-full">
                        {/* CABEÇALHO */}
                        <div className={`pb-1 border-t-2 w-full sticky top-[0.5px] bg-white shadow-lg h-[50px] items-center font-semibold flex  text-muted-foreground  justify-between text-center`}>
                            <div className="bg-gray border-r-2 text-center w-[80px] bg-white p-1">
                                     📆
                            </div>
                            ...
                            <div className="min-w-[70px] bg-white p-1 border-l-2 text-[14px] ">📝 </div>
                        </div>
                        {/* DIAS */}
                        {
                                ...
                                return (
                                    <>
                                        ...
                                        <div key={day.date.toDateString()} className={`flex flex-row border-b border-t border-black/1 align-middle items-center  justify-between text-center ${day.date > currentDate || day.date < currentDate ? "bg-muted" : "bg-[white] font-bold"}`}>
                                            ...
                                            <div className={`border-r bg-white border-black/5 text-center flex items-center justify-center min-w-[80px] min-h-[40px] text-sm text-muted-foreground align-middle`}>{formatDateToDdMmYy(day.date)}</div>
