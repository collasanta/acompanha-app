...
export default function EditableClientInfo({
  initialInfo,
  clientId,
}: {
  initialInfo: string;
  ...
  const hasContent =
    editableInfo && editableInfo !== "{}" && editableInfo !== "null";
    ...
    <div className="relative">
      ...
      <div
        className={cn(
          ...
          isEditing ? "max-h-[1000px]" : "max-h-[100px]"
        )}
      >
        <div
          className={cn(
        ...
        >
          ...
          {!isEditing && hasContent && (
            <div className="absolute inset-0 bg-gray-100 bg-opacity-10 pointer-events-none" />
          )}
        </div>
