...
export default function WorkoutRegistration() {
  ...
  async function registerWorkout() {
    ...
    try {
      ...
      if (result.workoutId) {
        console.log("Workout Registered Successfully!", result.workoutId)
  ...
  function onSubmit(values: WorkoutFormSchemaType) {
    const formWithEditorContent = {
      ...values,
      workoutDescription: editor?.getHTML() || '',
    }
    setFinalForm(formWithEditorContent)
    setValidForm(true)
  }
                ...
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Este treino poderá ser usado como base para outros clientes
                    </p>
                  </div>
                </FormItem>
              )}
                ...
                <AlertDialog open={!!finalForm}>
                  <AlertDialogContent>
                      ...
                      <AlertDialogDescription className="py-6">
                        <div className="flex flex-col space-y-2">
                          ...
                          <div className="flex flex-col space-y-2">
                            ...
                            <div dangerouslySetInnerHTML={{ __html: finalForm?.workoutDescription || '' }} />
                          </div>
                          <div className="flex flex-row space-x-2">
                          ...
                          <div className="flex flex-row space-x-2">
                            <div className="font-semibold">Cliente Atribuído:</div>
                    ...
                    <AlertDialogFooter>
                      ...
                      {isLoading ? (
                        <AlertDialogAction disabled className="mx-auto min-w-[90px]">
                        ...
                        <AlertDialogAction onClick={registerWorkout}>Confirmar</AlertDialogAction>
                      )}
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
